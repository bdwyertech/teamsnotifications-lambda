# lambda-layer-msteams-python

This is a sample template for lambda-layer-msteams-python - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name lambda-layer-msteams-python \
...
```bash
sam logs -n HelloWorldFunction --stack-name lambda-layer-msteams-python --tail
```
...
```bash
aws cloudformation delete-stack --stack-name lambda-layer-msteams-python
```
